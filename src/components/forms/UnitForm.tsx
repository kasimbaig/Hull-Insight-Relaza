...
export const UnitForm: React.FC<UnitFormProps> = ({
  ...
  console.log('UnitForm props:', { isOpen, unit, title, isSubmitting });
  ...
  useEffect(() => {
    if (isOpen) {
      if (unit) {
        setFormData({ name: unit.name, code: '' }); // Code will be fetched from API if needed
      } else {
